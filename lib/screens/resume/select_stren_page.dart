...
class SelectStrenPage extends StatefulWidget {
  ...
  const SelectStrenPage({super.key, required this.id, required this.selectedSkills});
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ExtraResumePage(
                      id: widget.id,
...
class StrenChooseButton extends StatefulWidget {
  ...
  @override
  State<StrenChooseButton> createState() => _StrenChooseButtonState();
}

class _StrenChooseButtonState extends State<StrenChooseButton> {
  // 출력할 스킬 목록
  var strength = [
    '빠른 손', '대처능력', '성실함', '사교성', '포용성', '의사소통',
...
void main() {
  runApp(MaterialApp(home: SelectStrenPage(id: 'some_id', selectedSkills: [])));
}
